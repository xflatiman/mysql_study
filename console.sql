...
CREATE TABLE catalogs(
    id SERIAL /*BIGINT UNSIGNED NOT NULL AUTO_INCREMENT UNIQUE*/ PRIMARY KEY,
...
CREATE TABLE users (
    ...
    updated_at DATETIME DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT 'Дата изменение учетной записи'
) COMMENT = 'Покупатели';
